...
# задан переменной окружения DER_ADB_KEYS (путь к adbkey.pub; build.sh экспортирует её из
# build.env). Зачем: у тестового телефона после каждой прошивки новая система и новый
